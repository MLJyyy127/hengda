...
INSERT INTO `auth_permission` VALUES (53, 'Can add 快捷留言', 14, 'add_quickfeedback');
INSERT INTO `auth_permission` VALUES (54, 'Can change 快捷留言', 14, 'change_quickfeedback');
INSERT INTO `auth_permission` VALUES (55, 'Can delete 快捷留言', 14, 'delete_quickfeedback');
INSERT INTO `auth_permission` VALUES (56, 'Can view 快捷留言', 14, 'view_quickfeedback');
...
-- ----------------------------
INSERT INTO `contactapp_ad` VALUES (1, '学思想', '撒的学生', '2026-01-02 16:29:00.000000');

-- ----------------------------
-- Table structure for contactapp_quickfeedback
-- ----------------------------
DROP TABLE IF EXISTS `contactapp_quickfeedback`;
CREATE TABLE `contactapp_quickfeedback`  (
  `id` bigint NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of contactapp_quickfeedback
-- ----------------------------
INSERT INTO `contactapp_quickfeedback` VALUES (1, '缪琳姣', '15708174377', '程序性的深V但是', '2026-01-03 05:09:54.730071', '好的', 'pending');
INSERT INTO `contactapp_quickfeedback` VALUES (2, '苏暖暖', '18200445398', '水擦拭', '2026-01-03 05:34:17.874828', '好的', 'completed');
INSERT INTO `contactapp_quickfeedback` VALUES (3, '缪琳姣', '15708174377', '生产线按时', '2026-01-03 06:19:03.908579', '好的', 'completed');
...
CREATE TABLE `contactapp_resume`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `contactApp_resume_ad_id_472c8998_fk_contactApp_ad_id`(`ad_id` ASC) USING BTREE,
  CONSTRAINT `contactApp_resume_ad_id_472c8998_fk_contactApp_ad_id` FOREIGN KEY (`ad_id`) REFERENCES `contactapp_ad` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 13 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of contactapp_resume
-- ----------------------------
INSERT INTO `contactapp_resume` VALUES (9, 'cxasx', '512081200508171385', '女', '1718352874@qq.com', '2007-07-05', '本科', '奇迹大陆艺术学校', '服装搭配与设计', 'sxxsacsacs', 'contact/recruit/2026_01_03/ncg_image_1742998048919.png', 1, '2026-01-03 05:54:03.085243', 1);
INSERT INTO `contactapp_resume` VALUES (10, 'cxasx', '512081200508171385', '女', '1718352874@qq.com', '2007-07-05', '本科', '奇迹大陆艺术学校', '服装搭配与设计', 'sxxsacsacs', 'contact/recruit/2026_01_03/ncg_image_1742998048919_5EhLZwV.png', 1, '2026-01-03 06:15:32.287496', 1);
INSERT INTO `contactapp_resume` VALUES (11, '撒旦从', '512081200508171385', '女', '1718352874@qq.com', '2007-06-12', '本科', '奇迹大陆艺术学校', '服装搭配与设计', '三线城市调查说的v想尝试', 'contact/recruit/2026_01_03/ncg_image_1743093194911.png', 1, '2026-01-03 10:43:48.658580', 1);
INSERT INTO `contactapp_resume` VALUES (12, '撒旦从', '512081200508171385', '女', '1718352874@qq.com', '2007-06-12', '本科', '奇迹大陆艺术学校', '服装搭配与设计', '三线城市调查说的v想尝试', 'contact/recruit/2026_01_03/ncg_image_1743093194911_OiYBENg.png', 3, '2026-01-03 10:43:00.000000', 1);
...
INSERT INTO `django_admin_log` VALUES (60, '2025-12-24 03:14:43.703605', '1', '缪琳姣 (202308241211)', 2, '[{\"changed\": {\"fields\": [\"\\u6240\\u5c5e\\u90e8\\u95e8\", \"Superuser status\", \"Groups\"]}}]', 13, 1);
INSERT INTO `django_admin_log` VALUES (61, '2025-12-24 03:27:38.881783', '1', '缪琳姣 (202308241211)', 2, '[{\"changed\": {\"fields\": [\"\\u6240\\u5c5e\\u90e8\\u95e8\", \"Superuser status\", \"Groups\"]}}]', 13, 1);
INSERT INTO `django_admin_log` VALUES (62, '2026-01-02 16:29:54.475545', '1', '学思想', 1, '[{\"added\": {}}]', 7, 1);
INSERT INTO `django_admin_log` VALUES (63, '2026-01-03 06:18:39.811649', '2', '苏暖暖', 2, '[{\"changed\": {\"fields\": [\"\\u5b98\\u65b9\\u56de\\u590d\\u5185\\u5bb9\"]}}]', 14, 1);
INSERT INTO `django_admin_log` VALUES (64, '2026-01-03 06:19:31.717754', '3', '缪琳姣', 2, '[{\"changed\": {\"fields\": [\"\\u5904\\u7406\\u72b6\\u6001\", \"\\u5b98\\u65b9\\u56de\\u590d\\u5185\\u5bb9\"]}}]', 14, 1);
INSERT INTO `django_admin_log` VALUES (65, '2026-01-03 06:19:36.679501', '2', '苏暖暖', 2, '[{\"changed\": {\"fields\": [\"\\u5904\\u7406\\u72b6\\u6001\"]}}]', 14, 1);
INSERT INTO `django_admin_log` VALUES (66, '2026-01-03 06:19:41.753365', '1', '缪琳姣', 2, '[{\"changed\": {\"fields\": [\"\\u5b98\\u65b9\\u56de\\u590d\\u5185\\u5bb9\"]}}]', 14, 1);
INSERT INTO `django_admin_log` VALUES (67, '2026-01-03 10:44:40.446737', '12', '撒旦从', 2, '[{\"changed\": {\"fields\": [\"\\u9762\\u8bd5\\u6210\\u7ee9\"]}}]', 8, 1);
INSERT INTO `django_admin_log` VALUES (68, '2026-01-03 10:59:44.751148', '12', '撒旦从', 2, '[{\"changed\": {\"fields\": [\"\\u9762\\u8bd5\\u6210\\u7ee9\"]}}]', 8, 1);
...
INSERT INTO `django_content_type` VALUES (14, 'contactApp', 'quickfeedback');
...
INSERT INTO `django_migrations` VALUES (35, 'contactApp', '0007_alter_resume_birth', '2025-12-30 14:06:25.850943');
INSERT INTO `django_migrations` VALUES (36, 'contactApp', '0008_quickfeedback', '2026-01-02 16:28:18.173783');
INSERT INTO `django_migrations` VALUES (37, 'contactApp', '0009_quickfeedback_reply_quickfeedback_status', '2026-01-03 06:18:03.830614');
INSERT INTO `django_migrations` VALUES (38, 'contactApp', '0010_remove_resume_position_resume_ad', '2026-01-03 10:31:33.475070');
...
INSERT INTO `django_session` VALUES ('w51ecyns4dwd40tjzcscanfoterqro82', '.eJxVjEEOgjAQRe_StWkqTGnHpXvOQKbTGYsaSCisjHdXEha6_e-9_zIDbWsZtirLMGZzMWdz-t0S8UOmHeQ7TbfZ8jyty5jsrtiDVtvPWZ7Xw_07KFTLt45tVGw9SueAQhRVEMbGq0rmhOCc7zg0TCggToLjBB5QsvOg2qB5fwDvyzhV:1vYFXq:04E2hzTilQ6ocuZPhyw0KWvURjdJf4K_YMAUdrLh1IU', '2026-01-07 03:28:14.240864');
...
-- ----------------------------
INSERT INTO `employees` VALUES (1, 'pbkdf2_sha256$1000000$ECgjnij4I6aqYOpzoha67Z$DTDdE4TwDE/kHsbYspj6cVn8hJen7jjHBaDkGhogDpE=', '2025-12-24 03:28:14.237352', 1, 'miaolinjiao', '琳姣', '缪', '1718352874@qq.com', 1, 1, '2025-12-20 08:17:27.879154', '202308241211', 'tech', '18200445398', '打工人', '2025-12-20', 1);
INSERT INTO `employees` VALUES (2, 'pbkdf2_sha256$1000000$Oc4lH2aCQvcQpaBKFDrvsm$FDeVZNB9tcABEDluxuObu0XNPTvXtt5IbXBPy30nBqY=', '2025-12-24 03:27:57.146346', 0, 'nikki', '', '', '', 1, 1, '2025-12-20 09:08:32.276136', '202312345678', 'news', '', '', NULL, 1);
...
-- ----------------------------
INSERT INTO `employees_groups` VALUES (9, 1, 5);
...
INSERT INTO `newsapp_mynew` VALUES (3, '公司荣获“2025年度科技创新企业”称号', '<p>在近日举办的“2025中国科技产业峰会”上，我司凭借在智能硬件与AI解决方案方面的突出贡献，荣获“年度科技创新企业”称号。评委会特别认可了我司在人脸识别安防系统和智能监控产品中的技术突破与场景应用能力，这是对公司持续投入研发、推动行业进步的充分肯定。</p>', '企业要闻', '2025-12-22 14:57:00.000000', 2, '');
...
-- ----------------------------
INSERT INTO `productsapp_product` VALUES (2, '智能清洁助手 Alpha', '全屋自动扫地、拖地、消毒，支持语音控制与智能路径规划，可自动倒垃圾。', '家用机器人', 298.0, '2024-08-02 14:33:00.000000', 4);
INSERT INTO `productsapp_product` VALUES (3, '陪伴型机器人 Buddy', '具备情感交互、语音聊天、儿童教育、老人陪伴、紧急呼叫等功能。', '家用机器人', 458.0, '2025-12-22 14:39:00.000000', 2);
INSERT INTO `productsapp_product` VALUES (4, '厨房料理机器人 ChefBot', '自动识别食材、推荐菜谱、辅助烹饪，支持联网更新食谱，语音交互操作。', '家用机器人', 1082.0, '2025-12-22 14:44:00.000000', 14);
INSERT INTO `productsapp_product` VALUES (5, '全景云台摄像头 360View', '360°旋转、4K高清、人形追踪、夜视增强、支持双向语音与哭声检测。', '智能监控', 255.0, '2025-12-22 14:47:00.000000', 1);
INSERT INTO `productsapp_product` VALUES (6, '零售客流分析方案 ShopInsight', '识别顾客属性（性别、年龄）、客流统计、热区分析、VIP识别，提升零售效率。', '人脸识别解决方案', 4500.0, '2025-12-22 14:50:00.000000', 2);
